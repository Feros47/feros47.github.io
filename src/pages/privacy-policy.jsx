...
const PrivacyPolicy = () => {
  return (
    <div>
      <h1 className="text-3xl text-center mt-12">Privacy Policy for ClubHub</h1>
      <p className="mt-4">
        At ClubHub, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by ClubHub and how we use it.
      </p>
      <p>
